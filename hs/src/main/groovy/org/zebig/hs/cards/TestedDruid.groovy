...
class AncientOfWar extends CardDefinition {
    AncientOfWar(Game game) {
        ...
        when_played(text) {
            def script1 = { this_minion.gains("+5 Health"); this_minion.gains(TAUNT) }
            def script2 = { this_minion.gains("+5 Attack") }
            you.choose(druid_choices, [script1, script2])
        }
    }
}
...
class Bite extends CardDefinition {
    Bite(Game game) {
        ...
        reserved_to = "Druid"
        when_played(text) {
            your_hero.gains("+4 Attack").until_end_of_turn()
            your_hero.armor += 4
        }
    }
}
...
class Cenarius extends CardDefinition {
    Cenarius(Game game) {
        ...
        when_played(text) {
            ...
            def script2 = {
                2.times {
                    game.summon(you, "Treant").gains(TAUNT)
                }
            }
            you.choose(druid_choices, [script1, script2])
        }
...
class Claw extends CardDefinition {
    Claw(Game game) {
        ...
        reserved_to = "Druid"
        when_played(text) {
            your_hero.gains('+2 Attack').until_end_of_turn()
            your_hero.armor += 2
        }
    }
}
...
class DruidOfTheClaw extends CardDefinition {
    DruidOfTheClaw(Game game) {
        ...
        get_targets = [null, null]
        when_played(text) {
            def script1 = { this_minion.gains(CHARGE) }
            def script2 = { this_minion.gains('+2 Health'); this_minion.gains(TAUNT) }
            you.choose(druid_choices, [script1, script2])
        }
    }
}
    ...
    ForceOfNature(Game game) {
        ...
        when_played(text) {
            3.times {
                ...
                treant.gains(CHARGE)
                treant.gains(DIE_AT_THE_END_OF_TURN)
            }
        }
    }
}
...
class MarkOfNature extends CardDefinition {
    MarkOfNature(Game game) {
        ...
        when_played(text) {
            ...
            def script1 = { m.gains("+4 Attack") }
            def script2 = { m.gains("+4 Health"); m.gains(TAUNT) }
            you.choose(druid_choices, [script1, script2])
        }
    }
}
...
class PowerOfTheWild extends CardDefinition { // Tested with Nourish
    PowerOfTheWild(Game game) {
        ...
        get_targets = [null, null]
        when_played(text) {
            def script1 = { your_minions*.gains("+1/+1") }
    ...
    SavageRoar(Game game) {
        ...
        when_played(text) {
            ...
            your_characters.each {
                it.gains('+2 Attack').until_end_of_turn()
            }
        }
    }
}
